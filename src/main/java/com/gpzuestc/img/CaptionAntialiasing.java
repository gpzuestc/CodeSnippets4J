 ...
 *
 */
public class CaptionAntialiasing implements ImageFilter
{
	/**
	 ...
	 */
	public CaptionAntialiasing(String caption, Font font, Color c, float alpha,
	 ...
	 * @param insets	The inset size around the caption.
	 */
	public CaptionAntialiasing(String caption, Font font, Color c, Position position,
			int insets)
	{
		this.caption = caption;
		this.font = font;
