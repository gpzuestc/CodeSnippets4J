...
////		 File f = new File("/Users/gpzuestc/快盘/[Pictures]/来自 GPZIP/相机胶卷/IMG_0063_x.jpg");
//		 File f = new File("/Users/gpzuestc/快盘/[Pictures]/来自 GPZIP/相机胶卷/IMG_0065_x.jpg");
//
//		   try {
//
...
//	}
	...
	public void base64ToImage() throws IOException{
		File f = new File(System.getProperty("user.dir") + "/src/main/java/com/gpzuestc/img/dataUrl.txt");
		String dataUrl = FileUtils.readFileToString(f);
		System.out.println(dataUrl);
		String[] parts = dataUrl.split(";base64,");
		String head = parts[0];
		String[] headParts = head.split("/");
		String format = headParts[1];
		System.out.println(format);
		System.out.println();
		String base64FileStr = parts[1];
		BASE64Decoder decoder = new BASE64Decoder();
		File of = new File("/Users/gpzuestc/Desktop/web2." + format);
		FileUtils.writeByteArrayToFile(of, decoder.decodeBuffer(base64FileStr));
		System.err.println();
